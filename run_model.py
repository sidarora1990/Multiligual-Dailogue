...
def get_test_op(sess,model,saver,model_file,batch_dict,param,logits,losses):
...
def perform_test(sess,model,saver,model_file,get_pred_sentence,param,logits,losses):
    ...
    for i in range(n_batches):
        ...
        test_op,cumulative_batch_loss=get_test_op(sess,model,saver,model_file,batch_dict,param,logits,losses)
